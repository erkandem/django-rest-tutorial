...
class OptionRawDataModel(models.Model):
    ...
    """
    id = models.CharField(db_column='pk', max_length=65, blank=False, null=False, primary_key=True)
    security_type = models.CharField(max_length=3, blank=False, null=False)
    exchange = models.CharField(max_length=6, blank=False, null=False)
    symbol = models.CharField(max_length=6, blank=False, null=False)
    option_symbol = models.CharField(max_length=6, blank=False, null=False)
    option_maturity = models.CharField(max_length=6,  blank=False, null=False)
    underlying_maturity = models.CharField(max_length=6, blank=False, null=False)
    last_trading_day = models.DateField(blank=False, null=False)
    bizdt = models.DateField(blank=False, null=False)
...
class CmeDataSetsModel(OptionRawDataModel):
    CME_SYMBOL_CHOICES = [('AD', 'AD'), ('BO', 'BO'), ('BP', 'BP'), ('BZ', 'BZ'), ('C', 'C'), ('CD', 'CD'), ('CL', 'CL'), ('EC', 'EC'), ('ES', 'ES'), ('FV', 'FV'), ('GC', 'GC'), ('HG', 'HG'), ('HO', 'HO'), ('JY', 'JY'), ('KW', 'KW'), ('LC', 'LC'), ('LN', 'LN'), ('NG', 'NG'), ('NQ', 'NQ'), ('RB', 'RB'), ('S', 'S'), ('SI', 'SI'), ('SM', 'SM'), ('TU', 'TU'), ('TY', 'TY'), ('US', 'US'), ('W', 'W')]
    exchange = models.CharField(max_length=6, blank=False, null=False, choices=[('CME', 'CME')])
    symbol = models.CharField(max_length=6, blank=False, null=False, choices=CME_SYMBOL_CHOICES)
